...
export default function Album() {
  ...
  function handleSubmit(val) {
    ...
    if (!business)
      alert(
        "Note: You haven't searched for intent query hence all data will be fetchted for this intent"
      );
    var obj = {};
    obj.val = val;
    obj.query = pathValue;
        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            ...
            <Typography
              ...
              paragraph
            >
              <i>One place for all Research Documents</i>
            </Typography>
        ...
        <Grid container justify="center">
          ...
          <Grid container justify="center">
            ...
            >
              ...
              <b>
                <i>
                  *Intent scores for categories will be displayed post search
                  query.
                </i>
              </b>
            </Typography>
                ...
                <Card className={classes.card}>
                  ...
                  <CardContent className={classes.cardContent}>
                    <Typography gutterBottom variant="h5" component="h2">
                      ...
                      {"\n"}
                      Similarity:{" "}
                      {(Math.round(card["_score"] * 100) / 100).toFixed(2)}
                    </Typography>
                    <Typography align="center">{card["_index"]}</Typography>
                  </CardContent>
                  <center>
                    <CardActions>
                      <Button
                        ...
                        color="primary"
                        onClick={() => {
                          window.open(card["_source"]["location"]);
                        }}
                      >
